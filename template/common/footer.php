        ...
        <footer>
            <div class="footer-info">
                <div class="info-column">
                    ...
                    <p style="font-size: 10px; color: #CCC;">希望您与我们联系</p>
                    <p>电话：+86 10 61234372</p>
                    <p>邮件：<a href="javascript:">给我们发送邮件</a></p>
                    <p>地址：<a href="javascript:">在地图上找到我们</a></p>
                </div>
                <div class="info-column">
                ...
                <div class="info-column">
                    <p style="font-weight: bold;">建议我们</p>
                    <p style="font-size: 10px; color: #CCC;">我们希望得到您的反馈</p>
                    <button class="travel-button">点击撰写反馈</button>
                </div>
            </div>
